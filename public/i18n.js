...
const DICT = {
  ...
  'info.appVersionNote': { ja: '（画面・機能の版）', en: '(App screens and features)' },
  'info.mapdataVersion': { ja: '地図データ：', en: 'Map data:' },
  'info.mapdataVersionNote': { ja: '（ポイント・ルート・スポット）', en: '(Points, routes and spots)' },
